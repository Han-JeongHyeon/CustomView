...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    public interface OnRatingChangeListener {
        void onRatingChange(com.example.custom.BaseRatingBar ratingBar, float rating, boolean fromUser);
    }
    ...
    private com.example.custom.BaseRatingBar.OnRatingChangeListener mOnRatingChangeListener;
    ...
    public void setOnRatingChangeListener(com.example.custom.BaseRatingBar.OnRatingChangeListener onRatingChangeListener) {
